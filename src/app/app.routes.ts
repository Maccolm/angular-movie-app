...
export const routes: Routes = [
	...
	{path: 'favorites', loadComponent: () => import('./pages/favorite-list-movie-page/favorite-list-movie-page.component').then( m => m.MovieFavoriteListPageComponent), canActivate: [authGuard]},
	{path: 'watch-list', loadComponent: () => import('./pages/movie-watchList-page/movie-watchlist-page.component').then(m => m.MovieWatchListPageComponent), canActivate: [authGuard]},
