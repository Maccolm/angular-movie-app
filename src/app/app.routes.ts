...
export const routes: Routes = [
	...
	{path: 'top_rated', loadComponent: () => import('./pages/top-rate-movie-page/top-rate-movie-page.component').then(m => m.MovieTopRatePageComponent)},
	{path: 'upcoming', loadComponent: () => import('./pages/upcoming-movie-page/upcoming-movie-page.component').then(m => m.MovieUpcomingPageComponent)},
